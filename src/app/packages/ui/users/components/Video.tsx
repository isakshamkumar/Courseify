...
const Video = ({ setselectedVideo,selectedVideo,setvideos ,setCourseProgress}) => {
  ...
  if (mounted) {
    return (
      ...
      <div className="flex flex-col gap-8">
        ...
        <div>
          <button disabled={selectedVideo.completed} onClick={handleEnded} className={`bg-green-500 text-white px-4 py-2 rounded-md mb-2`}>
